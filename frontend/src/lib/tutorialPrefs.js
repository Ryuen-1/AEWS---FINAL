...
export function hasSeenTutorial(userId) {
  ...
  try {
    ...
    console.warn('tutorialPrefs: failed to read seen status', e)
    return true
  }
}
...
export function setTutorialSeen(userId) {
  ...
  try {
    ...
    console.warn('tutorialPrefs: failed to set seen status', e)
  }
}
...
export function getPlayTutorialEveryLogin(userId) {
  ...
  try {
    ...
    console.warn('tutorialPrefs: failed to get play every login', e)
    return false
  }
}
...
export function setPlayTutorialEveryLogin(userId, value) {
  ...
  try {
    ...
    console.warn('tutorialPrefs: failed to set play every login', e)
  }
}
...
export function wasTutorialDismissedThisSession() {
  try {
    ...
    console.warn('tutorialPrefs: failed to read session dismissed', e)
    return false
  }
}
...
export function setTutorialDismissedThisSession() {
  try {
    ...
    console.warn('tutorialPrefs: failed to set session dismissed', e)
  }
}
