...
function readStorageEntry(storage) {
  try {
    ...
    console.warn('authStorage: failed to read entry', e)
  }
}
...
export function readStoredAuth() {
  ...
  try {
    ...
    console.warn('authStorage: failed to migrate legacy auth', e)
  }
...
export function writeStoredAuth(data) {
  ...
  try {
    ...
    console.warn('authStorage: failed to write auth', e)
  }
