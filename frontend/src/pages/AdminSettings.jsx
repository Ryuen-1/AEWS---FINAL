...
import { Shield, HelpCircle, PlayCircle } from 'lucide-react'
...
export default function AdminSettings() {
  ...
  const rightSection = (
    <div className="space-y-6">
      ...
      <PasswordChangeCard accent="slate" description="A verification code will be sent to your registered admin email before the password can be changed." />
