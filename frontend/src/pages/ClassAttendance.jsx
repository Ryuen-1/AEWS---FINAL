...
export default function ClassAttendance() {
  ...
  const attendanceFormat = attendanceData?.analytics?.attendance_format || 'daily'
  
  // Debug logging
  console.log('Attendance data:', attendanceData)
  console.log('Attendance analytics:', attendanceData?.analytics)
      ...
      {uploadingAttendance && (
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white rounded-xl shadow-2xl p-8 flex flex-col items-center gap-4">
            ...
            <p className="text-lg font-semibold text-slate-900">Uploading attendance sheet...</p>
